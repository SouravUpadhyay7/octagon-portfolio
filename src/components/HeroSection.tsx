        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div variants={imageVariants} initial="hidden" animate="visible" className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <motion.img src={image} alt="Dr. Jyoti Sekhar Banerjee" className="w-60 h-60 rounded-full object-cover border-4 border-primary shadow-lg shadow-primary/30 relative z-10" whileHover={{ scale: 1.05 }} transition={{ duration: 0.3 }} />
